...
# class investment:
#     def __init__(self, name, max_cost, min_cost, picture):
#         self.name = name
...
#         self.buy_entry = tk.Entry(self.frame, font=(FONT, TEXTSIZE), textvariable=self.buy_entry_variable)
#         self.buy_button = tk.Button(self.frame, text='Buy', font=(FONT, TEXTSIZE))
#
#     def place_widgets
...
class main:
    ...
    def _create_widgets(self):
        ...
        self.owned_real_estate_button = tk.Button(self.game_frame, text='Owned', command=lambda: self.real_estate_pages(2), font=(FONT, TEXTSIZE))
        self.unowned_real_estate_button = tk.Button(self.game_frame, text='Unowned', command=lambda: self.real_estate_pages(1), font=(FONT, TEXTSIZE))
    ...
    def _place_widgets(self, command):
        if command == 'start':
            ...
            self.owned_real_estate_button.grid(row=0, column=3, padx=10)
            self.unowned_real_estate_button.grid(row=0, column=2)
